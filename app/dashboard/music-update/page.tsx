  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Manage Music Library</h1>
          <p className="text-muted-foreground">Add, edit, and manage songs in the Ark of Light music library.</p>
        </div>
